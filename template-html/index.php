...
<head>
    ...
    .psd{padding-right: 20px;background: url(https://dl.dropboxusercontent.com/u/62557375/temp/site/psd.png) no-repeat right}
    </style>
...
<body>
    <div class="main">
        <h1>name</h1>
        <ul>
            <li><a href="index.html" target="_blank">index.html</a> (<span class="psd">PSD.psd</span>)</li>
            <li><a href="index.html" target="_blank">index.html</a> (<span class="psd">PSD.psd</span>)</li>
            <li><a href="index.html" target="_blank">index.html</a> (<span class="psd">PSD.psd</span>)</li>
        </ul>
        <div class="img">
