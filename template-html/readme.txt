...
Стили собраны в один с помощью CSS препроцессора - Compass.
...
3) Если у пользователя браузер IE (<=9) или opera, будет загружаться js/placeholder.min.js, который призван корректно отображать placeholder в полях ввода.
