(function(a){a.fn.selectjs=function(){return this.each(function(){var b=!0,c=this,e=a(".slctdrop-js"),d=a(c).find(e);a(c).on("click","div",function(){e.hide();a(this).toggleClass("active").next().slideToggle();return!1});d.on("click","li",function(){var b=a(this),c=b.text(),d=b.data("option");b.parent().siblings("div").text(c).removeClass("active").next().hide().end().parent().children("input").val(d).trigger("change")});a(document).click(function(e){b&&!a(e.target).closest(d).length&&(d.hide(),a(c).find("div").delay(400).queue(function(b){a(this).removeClass("active");
